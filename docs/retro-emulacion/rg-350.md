...
La tarjeta externa es casi equivalente a la segunda partición de la interna, es decir, sirve para contener aplicaciones. También es donde se suelen colocar las ROMs. Esta tarjeta externa puede estar en formatos FAT32 o los propios de Linux (ext2, ext3, ext4). ROGUE soporta además exFAT.
