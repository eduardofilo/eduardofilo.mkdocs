...
* `/usr/local`: Monta el directorio `local` de la segunda partición de la SD interna.
* `/media/data/apps`: Monta el directorio `apps` de la segunda partición de la SD interna.
* `/media/sdcard`: Monta la SD externa.

## Directorios importantes

* `/media/home`: Configuraciones. En realidad es un enlace simbólico de `/usr/local/home`. Contiene cosas como:
