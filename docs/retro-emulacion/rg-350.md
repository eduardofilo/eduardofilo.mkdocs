...
|`/media/data/local/home/.pcsx4all/`|Datos del emulador PCSX4All. Consultar [aquí](https://github.com/retrogamehandheld/OpenDingux/wiki/Standard-file-locations) otros directorios de datos de otras aplicaciones|
