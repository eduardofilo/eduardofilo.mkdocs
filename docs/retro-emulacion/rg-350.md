...
|`/media/data/local/home/.pcsx4all/`|Configuraciones del emulador PCSX4All (como las memory cards o los save states). Consultar [aquí](https://github.com/retrogamehandheld/OpenDingux/wiki/Standard-file-locations) otros directorios de datos de otras aplicaciones|
