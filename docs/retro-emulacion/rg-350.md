...
|`/media/data/local/home/.pcsx4all/`|Configuraciones del emulador PCSX4All (como las memory cards o los save states). Consultar [aquí](https://github.com/retrogamehandheld/OpenDingux/wiki/Standard-file-locations) los directorios de datos de otras aplicaciones|
...
|`/usr/local/home/.handy`|BIOS Handy (Atari Lynx)|
|`/usr/local/home/.Temper/syscards`|BIOS Temper (PC Engine)|
|`/usr/local/home/.picodrive`|BIOS Picodrive (Mega CD)|
|`/usr/local/home/.gpsp/gba_bios.bin`|BIOS Gpsp (GameBoy Advance)|
