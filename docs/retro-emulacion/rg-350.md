...
Una vez que en el log haya algo que mostrar aparecerá un lanzador nuevo de nombre `Log Viewer` donde podremos consultar la salida de error del proceso que se ha cerrado y con suerte obtener alguna pista sobre el motivo del cierre:
