...
* **Atari 5200**: Hay que colocar la BIOS en `/media/data/local/home/5200.rom`. Las ROMs pueden estar en cualquier lugar porque el emulador permite seleccionar la ROM al abrirlo mediante un explorador de ficheros, pero deben estar descomprimidas y con extensión `.a52`.
