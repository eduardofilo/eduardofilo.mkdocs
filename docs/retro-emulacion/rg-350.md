...
## Emuladores? Juegos? Ports? ROMS? Aplicaciones?
...
Los ports son los que aparecen en Games. Nada impide que un emulador aparezca dentro de Games, pero todo el mundo pone las cosas siguiendo esta organización.

Un port es una aplicación que ejecuta un juego cualquiera. Normalmente un clásico del que se dispone del código y que alguien ha compilado para la RG-350. Luego están los remakes hechos por aficionados o homebrew.
...
* Port: Un juego concreto normalmente un clásico de PC, un remake o juego indie (homebrew). En la RG350 tendrán forma de OPK.
...
Las BIOS son unos ficheros parecidos a las ROMs que a diferencia de éstas están siempre presentes en la máquina. Los emuladores o bien incorporan una reimplementación (como el HLE de Pcsx4all) o bien es necesario que las pongamos nosotros. Aún en ese primer caso es conveniente utilizar la BIOS original. Si no la incluyen los emuladores es porque son código propietario del fabricante de la máquina, lo que impediría la libre distribución del emulador. Lo mismo que sucede con las ROMs
