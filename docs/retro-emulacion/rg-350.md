...
* **Run and Gun**: Para saltar el Memory Check, enchufar un teclado al puerto USB1/OTG y pulsar F7. Otra opción es mapear L2 y R2 a F2 (`Service mode` en `Input (this game)`) y F3 (`Reset game` en `Input (general)`) y pulsarlos a la vez.
