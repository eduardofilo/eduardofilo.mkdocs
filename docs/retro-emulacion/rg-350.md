...
* Frontends:
    * [PyMenu](https://github.com/JackD83/PyMenu/releases)
...
* Repuestos componentes:
    ...
    * [Sticks de perfil bajo](https://www.ebay.fr/itm/153807357237). [Vídeo de instalación](https://www.youtube.com/watch?v=qD3Blz9gQRg)
    * Batería:
...
|`/media/data/local/home/.gmenu2x/skins/<nombre_tema>/wallpapers`|Fondos de pantalla de Gmenu2x|
