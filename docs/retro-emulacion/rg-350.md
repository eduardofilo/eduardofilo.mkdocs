...
* Repuestos componentes:
    * Pantalla: [Compra](https://es.aliexpress.com/item/4000318225148.html); [Tutorial de instalación](https://www.youtube.com/watch?v=soAQnL6Vfng)
    ...
    * [Sticks de perfil bajo](https://www.ebay.fr/itm/153807357237)
    * [Batería 3.7V 2500mAh](https://es.aliexpress.com/item/33008552247.html): No inclue conector JST por lo que habrá que soldar el que lleva la batería original.
...
En Linux no es necesario, pero en Windows, dependiendo de la versión hay que instalar un driver. En el post inicial de [este foro](https://www.elotrolado.net/hilo_rg-350-game-kiddy-gdk350-350h-y-otras-alternativas-a-la-gcw-zero-con-el-jz4770_2341546_s5450) lo comentan.
...
* **Metal Gear Solid** (PS): Desactivar HLE en el emulador y seleccionar BIOS `scph1001.bin` (instrucciones [aquí](#bios-de-playstation)). [BIOS de sistemas](https://replayers.org/bios-files/). Realmente este ajuste, aunque imprescindible para MGS y otros, es recomendable en general.
...
* **Run and Gun**: Para saltar el RAM/ROM check, enchufar un teclado al puerto USB1/OTG y pulsar F7. Otra opción es mapear L2 y R2 a F2 y F3 y pulsarlos a la vez.

#### Particularidades emuladores

* [**Atari 5200**](https://github.com/retrogamehandheld/OpenDingux/raw/master/Emulators/A5200(Explorer)_2013-06-15.opk): Hay que colocar la BIOS en `/media/data/local/home/5200.rom`. Las ROMs pueden estar en cualquier lugar porque el emulador permite seleccionar la ROM al abrirlo mediante un explorador de ficheros, pero deben estar descomprimidas y con extensión `.a52`.
