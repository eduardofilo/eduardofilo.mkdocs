...
Como dato adicional, para que la nueva sección tenga icono propio, hay que colocar el icono png de 32x32 con el mismo nombre de la sección creada (`doom.png` en el ejemplo) en la ruta: `/media/data/local/home/.gmenu2x/skins/<theme>/sections` donde `<theme>` se corresponde con el skin que estemos usando.
