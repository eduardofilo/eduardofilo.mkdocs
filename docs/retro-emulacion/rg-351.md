...
|:---------|:--------|
|`/storage/.config/emulationstation/es_systems.cfg`|Definición de sistemas en EmulationStation|
|`/storage/.config/emulationstation/themes/`|Themes EmulationStation|
