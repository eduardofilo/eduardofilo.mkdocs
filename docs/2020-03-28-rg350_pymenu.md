...
Como con todos los OPKs solo tenemos que copiarlo a uno de estos dos directorios:
...
Los dos primeros controlan el comportamiento del indicador de batería. Según comunicación de su autor, los parámetros se ajustan automáticamente cargando completamente la batería y dejando que se descargue del todo.
