...
![PyMenu System Select](/images/posts/pymenu_system_select.png.png)
...
El tema se selecciona desde el icono de ruenda dentada que hay abajo a la izquierda en la pantalla principal. Al pulsar sobre ella aparecen los `General Settings`, siendo el tema uno de ellos. Una vez seleccionado, como siempre en PyMenu, hay que confirmar los cambios pulsando `Start`:
...
La opción `Exit to Gmenu2x` la he incorporado yo modificando el código.
