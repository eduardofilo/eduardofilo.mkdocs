...
Los dos primeros controlan el comportamiento del indicador de batería. Según su autor los parámetros se ajustan automáticamente cargando completamente la batería y dejándo que se descargue del todo.
...
#### Problema con la Identificador de sistema
