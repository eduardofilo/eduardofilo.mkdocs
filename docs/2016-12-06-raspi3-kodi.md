...
8. Para cada uno de ellos se selecciona a la derecha un scraper que es una base de datos en internet con metainformación. Por defecto solo contamos con uno, aunque se pueden activar más por medio de add-ons.
