...
Recientemente a aparecido un modelo de RG350 llamado RG350M con unas pocas actualizaciones, de las cuales la más importante es la pantalla. Si en el modelo original la pantalla tiene una resolución de 320x240, en el nuevo modelo es de 640x480. Es decir con 4 veces el número de píxeles de la original.
