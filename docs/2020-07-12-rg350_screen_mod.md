...
* Pérdida de sincronismo vertical (imagen parecida al aspecto de la vieja codificación de Canal+) en ciertas situaciones (durante un segundo al reiniciar y sobre todo en pantallas de texto, tipo terminal).
...
![Carcasa limpia](/images/posts/screen_mod/carcasa_limpia.jpg)
