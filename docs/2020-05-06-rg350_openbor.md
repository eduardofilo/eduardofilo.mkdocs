...
El emulador tiene forma de OPK, como la mayoría de los emuladores para el sistema de la RG350 (OpenDingux). Por tanto solo tenemos que bajarlo de [este enlace](https://github.com/SeongGino/RetroGame350-AppRepo/raw/master/Games-Ports/OpenBOR_3.0_r4165_GCW0_Edition.opk) y copiarlo a una de las dos rutas que explora GMenu2X para mostrar los lanzadores, es decir:
