...
!!! abstract "[Instalación OpenCode, OmniRoute y Ponytail](2026-07-26_opencode_omniroute.md)"
    ...
    Instalación y configuración de OpenCode con OmniRoute y Ponytail para programar con agentes de IA minimizando uso de cuotas y costes.
...
!!! abstract "[Instalación Arch Linux en Lenovo ThinkPad T480](2025-06-28_thinkpad_t480.md)"
    ...
    Procedimiento completo para instalar Arch Linux en un Lenovo ThinkPad T480 con dual boot.
...
!!! abstract "[Instalación Arch Linux en Steam Deck](2024-09-04_steam_deck_arch.md)"
    ...
    Procedimiento completo para instalar Arch Linux junto a SteamOS con dual boot en Steam Deck.
...
!!! abstract "[Entrevista en Podcast Linux](2022-10-05_entrevista_podcast_linux.md)"
    ...
    Entrevista en Podcast Linux sobre la imagen Adán para RG350/280.
