...
* Añadir las siguientes líneas al fichero `$DOKU_BASE/lib/tpl/monobook/context.php`:
    ```php
    ...
    ```
* Inmediatamente antes de la línea (en la versión de 2007-10-03 es la línea #354):
    ```php
    $monobook['defaulttoolbox']['whatlinkshere']['href'] = DOKU_BASE."doku.php?id=".$ID."&amp;do=backlink";
    ```
* Añadir la línea siguiente al fichero `$DOKU_BASE/lib/tpl/monobook/lang/es/lang.php`:
    ```php
