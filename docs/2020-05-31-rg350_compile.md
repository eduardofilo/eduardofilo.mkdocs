...
8. Solo queda empaquetar el binario y sus recursos (gráficos, sonidos, fichero `.desktop` para el lanzador, etc.). Existe un pequeño script que lo hace por nosotros, así que lo utilizamos:
