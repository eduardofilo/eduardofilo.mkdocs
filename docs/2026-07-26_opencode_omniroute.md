...
!!! Note "FreeLLMAPI"
    Una alternativa, también ejecutable en nuestra máquina, conocida después de escribir el artículo y especializada en enrutar modelos gratuitos, es [FreeLLMAPI](https://freellmapi.co/es/). En [este vídeo](https://youtu.be/7Oez8kmknOA) puede verse una descripción y tutorial de configuración.
