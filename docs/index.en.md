...
!!! abstract "[Second brain in Obsidian with the LLM Wiki pattern](2026-09-19_llm_wiki_obsidian.en.md)"
    ...
    Obsidian vault with LLM Wiki conventions managed by Hermes.
...
!!! abstract "[OpenCode, OmniRoute, and Ponytail Installation](2026-07-26_opencode_omniroute.en.md)"
    ...
    Installing and configuring OpenCode with OmniRoute and Ponytail for AI agent programming while minimizing quotas use and costs.
...
!!! abstract "[G&W Zelda hack](2026-03-08_zelda_gw.md)"
    ...
    Installation of alternative firmware on G&W Zelda and modification to add microSD slot.

!!! abstract "[Arch Linux Installation on Lenovo ThinkPad T480](2025-06-28_thinkpad_t480.md)"
