...
1. En la placa existe además otro chip que implementa el estándar USB y conecta el microcontrolador con un PC.
...
Además del programadoro adaptador ISP que elijamos, necesitamos un programa que implemente este protocolo. Aquí, aparte de las herramientas oficiales, en mi mano tenía dos opciones:
...
3. Flasheo primero el bootleader (ya que si empiezo por los fusebits temo perder la capacidad para comunicar con el chip):
