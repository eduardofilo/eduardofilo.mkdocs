...
* [Gerbers](https://github.com/eduardofilo/eduzebox/tree/master/gerber)
* [BOM](https://github.com/eduardofilo/eduzebox/blob/master/bom.ods)
* [Firmware (Bootloader)](http://uzebox.org/forums/download/file.php?id=2044&sid=17ded19d5583c1780e48905a3dc26ced)
* [Carcasa](https://github.com/eduardofilo/eduzebox/tree/master/case)
...
1. Cortaremos con un alicate de corte el alojamiento derecho (mirándolo de frente) para el tornillo de chasis del Euroconector.
