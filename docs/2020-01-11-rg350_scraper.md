...
El nombre de archivo de las imágenes tiene que ser el mismo que la ROM sustituyendo la extensión de la ROM por `PNG`. Por ejemplo la miniatura de la ROM `/media/sdcard/roms/GB/DKLAND.gb` iría en `/media/sdcard/roms/GB/.previews/DKLAND.png`.
